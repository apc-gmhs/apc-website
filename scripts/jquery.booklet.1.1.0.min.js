...
(function (b) {
  ...
  function a(ac, ae, G) {
    ...
    if (
      !isNaN(av.startingPage) &&
      av.startingPage <= av.pTotal &&
      av.startingPage > 0
    ) {
    ...
    if (av.menu) {
      ...
      if (av.pageSelector) {
        q = b(
          '<div class="b-selector b-selector-page"><span class="b-current">' +
            (E + 1) +
            " - " +
            (E + 2) +
            "</span></div>"
        ...
        for (L = 0; L < av.pTotal; L += 2) {
          ...
          if (av.direction == "RTL") {
            nums =
              Math.abs(I - av.pTotal) - 1 + " - " + Math.abs(I - av.pTotal);
            if (av.closed) {
              if (L == av.pTotal - 2) {
                nums = "1";
              } else {
                if (L == 0) {
                  ...
                  nums =
                    Math.abs(I - av.pTotal) -
                    3 +
                    " - " +
                    (Math.abs(I - av.pTotal) - 2);
                }
              }
              if (av.covers) {
                if (L == av.pTotal - 2) {
      ...
      if (av.chapterSelector) {
        ...
        u = b(
          '<div class="b-selector b-selector-chapter"><span class="b-current">' +
            X +
            "</span></div>"
        ).appendTo(l);
      ...
      gotoPage: function (i) {
        if (i > av.curr && i < av.pTotal && i >= 0 && !ad) {
          ...
          W.stop()
            ...
            .animate({ left: 0, width: av.pWidth, paddingLeft: 0 }, av.speedH);
          c.animate({ left: av.shadowBtmWidth }, av.speedH, av.easeIn).animate(
            { left: 0 },
            av.speedH,
            av.easeOut,
            function () {
          ...
          if (i < av.curr && i < av.pTotal && i >= 0 && !ad) {
            ...
            ab.animate(
              { left: av.pWidthH, width: av.pWidthH },
              av.speedH,
              av.easeIn
            ).animate(
              { left: av.pWidth, width: av.pWidth },
              av.speedH,
              av.easeOut
            );
            ag.animate(
              ...
              av.speedH,
              av.easeIn
            ).animate({ right: 0 }, av.speedH, av.easeOut, function () {
              H();
            });
          }
        }
    ...
    if (av.overlays) {
      ak = b(
        '<div class="b-overlay b-overlay-prev b-prev" title="Previous Page"></div>'
      ).appendTo(S);
      al = b(
        '<div class="b-overlay b-overlay-next b-next" title="Next Page"></div>'
      ).appendTo(S);
      T = S.find(".b-overlay");
      if (b.browser.msie) {
        T.css({
    ...
    if (av.tabs) {
      ai = b(
        '<div class="b-tab b-tab-prev b-prev" title="Previous Page">Previous</div>'
      ).appendTo(S);
      aj = b(
        '<div class="b-tab b-tab-next b-next" title="Next Page">Next</div>'
      ).appendTo(S);
      R = S.find(".b-tab");
      if (av.tabWidth) {
        R.width(av.tabWidth);
    ...
    if (av.arrows) {
      B = b(
        '<div class="b-arrow b-arrow-prev b-prev" title="Previous Page"><div>Previous</div></div>'
      ).appendTo(S);
      D = b(
        '<div class="b-arrow b-arrow-next b-next" title="Next Page"><div>Next</div></div>'
      ).appendTo(S);
      m = S.find(".b-arrow");
      if (av.direction == "RTL") {
      ...
      e.hover(
        function () {
          if (!ad && av.curr + 2 <= av.pTotal - 2) {
            ...
            W.stop().animate(
              { left: av.width - 40, width: 20, paddingLeft: 10 },
              500,
              av.easing
            );
            C = true;
        ...
        function () {
          if (!ad && av.curr + 2 <= av.pTotal - 2) {
            ...
            W.stop().animate(
              { left: av.width, width: 0, paddingLeft: 0 },
              500,
              av.easing
            );
            C = false;
      ...
      A.children().each(function (j) {
        ...
        if (b(this).hasClass("b-page-empty")) {
          ...
          if (
            av.closed &&
            av.covers &&
            (j == 1 || j == A.children().length - 2)
          ) {
            b(this).wrap(
              '<div class="b-page"><div class="b-wrap b-page-cover"></div></div>'
            );
          } else {
            if (j % 2 != 0) {
              b(this).wrap(
                '<div class="b-page"><div class="b-wrap b-wrap-right"></div></div>'
              );
            } else {
              b(this).wrap(
                '<div class="b-page"><div class="b-wrap b-wrap-left"></div></div>'
              );
            }
          }
        }
        ...
        if (
          av.pageNumbers &&
          !b(this).hasClass("b-page-empty") &&
          (!av.closed ||
            (av.closed && !av.covers) ||
            (av.closed && av.covers && j != 1 && j != A.children().length - 2))
        ) {
          if (av.direction == "LTR") {
            I++;
          }
    ...
    function aa() {
      ...
      if (av.shadows) {
        ax = b('<div class="b-shadow-f"></div>')
          .appendTo(W)
          .css({ right: 0, width: av.pWidth, height: av.pHeight });
        az = b('<div class="b-shadow-b"></div>')
          .appendTo(ab)
    ...
    function Q(j, i, p) {
      ...
      if (av.shadows) {
        if (b.support.opacity) {
          p.animate({ opacity: 1 }, av.speedH, av.easeIn).animate(
            { opacity: 0 },
            av.speedH,
            av.easeOut
          );
